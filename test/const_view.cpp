...
TEST_F(ConstViewTest, Basic) {
  ...
  {
    const Array<int> array(sizes, values);
    ConstView<int> view(array.view());
...
TEST_F(ConstViewTest, Begin) {
  ConstArray<int> array(sizes, values);
  ConstView<int> view(array.view().set_range_begin(2, 3).
...
TEST_F(ConstViewTest, End) {
  ConstArray<int> array(sizes, values);
  ConstView<int> view(array.view().set_range_end(2, 3).
...
TEST_F(ConstViewTest, Fix) {
  ConstArray<int> array(sizes, values);
  ConstView<int> view(array.view().fix_dimension(3, 2));
...
TEST_F(ConstViewTest, FullMixed) {
  ConstArray<int> array(sizes, values);
  ConstView<int> view(array.view().set_range_begin(5, 1).
...
TEST_F(ConstViewTest, Stride) {
  ConstArray<int> array(sizes, values);
  ConstView<int> view(array.view().set_range_stride(2, 3).
